...
function EmailVerify() {
  ...
  // Redirect verified users away from the verification page.
  useEffect(() => {
    const isVerified = userData?.isAccountVerified === true || userData?.isEmailVerified === true;
    ...
    if (isVerified) {
      console.log('Verified user detected on email verification page. Redirecting to dashboard...');
