      ...
      <main className="w-full">
        ...
        <section className="py-20 relative w-full">
          ...
          <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 relative z-10">
            ...
            >
              <div className="bg-gradient-to-br from-slate-800 to-slate-800/80 p-6 lg:p-8 rounded-2xl shadow-lg hover:shadow-blue-500/10 
                ...
                <h3 className="text-xl lg:text-2xl font-bold text-white mb-4">Advanced Analytics</h3>
              ...
              <div className="bg-gradient-to-br from-slate-800 to-slate-800/80 p-6 lg:p-8 rounded-2xl shadow-lg hover:shadow-blue-500/10 
                ...
                <h3 className="text-xl lg:text-2xl font-bold text-white mb-4">Bank-Grade Security</h3>
                <p className="text-gray-300 text-sm lg:text-base">
              ...
              <div className="bg-gradient-to-br from-slate-800 to-slate-800/80 p-6 lg:p-8 rounded-2xl shadow-lg hover:shadow-blue-500/10 
                ...
                <h3 className="text-xl lg:text-2xl font-bold text-white mb-4">Smart Trading</h3>
                <p className="text-gray-300 text-sm lg:text-base">
        ...
        {/* CTA Section */}
        <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-700 relative overflow-hidden w-full">
        ...
        {/* Stats Section */}
        <section ref={statsRef} className="py-16 bg-slate-800/50 relative overflow-hidden w-full">
          <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
            <motion.div
              {...fadeInUp(0.2)}
              className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8"
            >
              <div className="bg-gradient-to-br from-slate-800 to-slate-800/80 p-6 lg:p-8 rounded-2xl shadow-lg border border-slate-700/50 backdrop-blur-sm text-center">
                <h3 className="text-4xl lg:text-5xl font-bold text-white mb-2">${Math.floor(tradingVolume)}M+</h3>
                <p className="text-blue-400 font-medium">Trading Volume</p>
              </div>
              <div className="bg-gradient-to-br from-slate-800 to-slate-800/80 p-6 lg:p-8 rounded-2xl shadow-lg border border-slate-700/50 backdrop-blur-sm text-center">
                <h3 className="text-4xl lg:text-5xl font-bold text-white mb-2">{Math.floor(activeUsers)}K+</h3>
...
function ContactSection() {
  ...
  return (
    <section className="py-20 bg-slate-800 relative w-full" ref={contactRef}>
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
      ...
      <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16">
          <div className="bg-gradient-to-br from-slate-800 to-slate-800/80 p-6 rounded-xl backdrop-blur-sm border border-slate-700/50 shadow-lg">
            ...
            <p className="text-gray-300">investup@investuptrading.com</p>
          </div>
