...
const Faqs = () => {
  ...
  useEffect(() => {
    setFaqs([
      ...
      },
      {
        ...
        answer: "We prioritize the security of your funds. Our platform uses advanced encryption and security protocols to protect your assets."
      },
      {
      ...
      },
      {
        ...
        answer: "While we take measures to protect your funds, your staked funds are entirely risk-free."
      }
    ]);
  }, [settings]);
  ...
  return (
    <>
      <Navbar />
      <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white py-24 px-4 sm:px-6 lg:px-8">
        <motion.div 
