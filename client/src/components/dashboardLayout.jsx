    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 w-full">
            ...
            <div className="flex w-full">
                ...
                <div className="hidden lg:flex lg:w-64 xl:w-72 lg:flex-col fixed inset-y-0 pt-16">
                    <div className="flex-1 flex flex-col min-h-0 bg-slate-800/50 backdrop-blur-sm border-r border-slate-700/50 w-full">
                ...
                <div className="fixed bottom-0 left-0 right-0 z-40 lg:hidden bg-slate-800/90 backdrop-blur-sm border-t border-slate-700/50">
                ...
                {/* Main content */}
                <div className="flex-1 lg:pl-64 xl:pl-72 pt-16 pb-20 lg:pb-0 w-full">
